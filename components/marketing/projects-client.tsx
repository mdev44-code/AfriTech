...
import { PROJECT_CATEGORIES, type ProjectCategory } from "@/lib/validations/project";
...
export function ProjectsClient({ projects, title, description }: ProjectsClientProps) {
          ...
          >
            <AnimatePresence mode="popLayout" initial={false}>
              {filteredProjects.map((project) => {
                const Icon = CATEGORY_ICON[project.category as ProjectCategory] ?? Globe;
