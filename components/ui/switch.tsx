...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ref={ref}
    className={cn(
      "peer inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border border-white/10 transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-blue-light disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-brand-blue data-[state=unchecked]:bg-white/10",
      className
    )}
    {...props}
  >
